...
struct K {
    ...
    static let coverArtDict: [String: (UIColor, UIColor, String)] = [
        "Likes": K.Colors.likesCoverArt,
        "Downloads": K.Colors.downloadsCoverArt
    ]
    ...
    struct Colors {
        ...
        static let albumCoverArt = (#colorLiteral(red: 0.8549019694, green: 0.250980407, blue: 0.4784313738, alpha: 1), #colorLiteral(red: 0.9803808331, green: 0.9128970504, blue: 0.9070027471, alpha: 1), "music.note.list")
